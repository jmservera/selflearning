...
|-----------|----------|----------|
| System architecture & design | Morpheus | Component design, pipeline orchestration, trade-offs |
| Web scraping & crawling | Trinity | Scrapers, crawl scheduling, data ingestion, content extraction |
| Data pipelines & ETL | Trinity | Data transformation, cleaning, pipeline stages |
...
| Testing & QA | Niobe | Write tests, find edge cases, verify fixes |
| Evaluation metrics | Niobe | Knowledge accuracy, coverage measurement, improvement tracking |
